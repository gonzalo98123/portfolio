<nav class="navbar navbar-expand-md mb-4">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="d-inline">
                <a href="https://docs.google.com/document/d/18z6fzui9CKN8wwlb2AnlbT0V9yjihPPS/edit?usp=sharing&ouid=102366150601615894869&rtpof=true&sd=true" target="_blank" class="btn btn-rojo">Descargar mi CV <i class="fas fa-download"></i></a>
            </div>
        </div>
    </div>
    </div>
